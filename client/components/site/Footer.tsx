    ...
    <footer className="border-t bg-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 grid gap-10 md:grid-cols-4">
        <div>
          ...
          <p className="mt-4 text-sm text-muted-foreground max-w-xs">Modern rentals you can trust. Find, tour, and apply in minutes.</p>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <li><a href="#" className="hover:text-foreground">Market Insights</a></li>
      ...
      <div className="border-t py-6 text-center text-xs text-muted-foreground">© {new Date().getFullYear()} Rentora, Inc. All rights reserved.</div>
    </footer>
  );
}
